...
// Check if there's existing data in local storage and update the variables.
...
function selectOption(option) {
  ...
  // Update correct and incorrect answers and save them to local storage.
  if (
    nextTextNodeId === 8 ||
    nextTextNodeId === 13 ||
    nextTextNodeId === 16 ||
...
// Display the leaderboard on your webpage.
function displayLeaderboard() {
  // Create a leaderboard element.
  ...
  `;
  // Add the leaderboard element to the DOM.
